...
public class MovieAddView implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("영화 추가 = "+query);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("movieList/movieAdd.jsp");
