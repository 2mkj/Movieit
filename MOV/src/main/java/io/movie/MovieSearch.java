...
public class MovieSearch implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		// 1. 검색어 가져오기
		String query = request.getParameter("movie_title");
		...
		Movie movie = dao.movie_search(query);
		request.setAttribute("movie", movie);
		RequestDispatcher dispatcher = request.getRequestDispatcher("movieList/movieView.jsp");
