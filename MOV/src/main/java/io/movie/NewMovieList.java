...
public class NewMovieList implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<Zzim> z = new ArrayList<Zzim>();
		z = zdao.preZzim();
		
		// 1. 검색어 가져오기
				String query = request.getParameter("title");
				String mdate = request.getParameter("mdate");
				System.out.println("박스오피스 영화 : " + query);
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("movieList/movieList.jsp");
