...
<body>
<%--게시판 수정 --%>
<form action="noticeModify.no" method="post" name="modifyform" id="comm">
...
<!-- 작성 페이지 -->
 <thead>
   <tr>
    ...
    <tr>
    	<td>글쓴이</td>
    	<td colspan="4"><input class="inputname" type="text" name="user_name" value="${c.board_user_name}" readOnly></td>
    </tr>
    <tr>
    	<td>제목</td>
