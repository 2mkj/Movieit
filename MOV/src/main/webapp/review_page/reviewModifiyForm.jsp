...
<body>
	<div class="container">
		<h3>리뷰 수정 페이지</h3>
		<form action="ReviewModifiyAction.com" method="post">
			${review_move_name}
			...
			<div class="form-group mb-3">
				...
				<input type="text" class="form-control" id="review_title" name="review_title" placeholder="Enter Title" value="${review_title }">
			</div>
			<div class="form-group mb-3">
			...
			<div class="form-group mb-3">
				...
				<textarea class="form-control" name="review_content" id="review_content" cols="30" rows="10" class="col-12">${review_content }</textarea>
			</div>

			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				<input class="btn btn-secondary me-md-2" type="submit"  value="리뷰등록">
				<button class="cancelButton btn btn-light" type="button">취소</button>
			</div>
		</form>
	</div>
